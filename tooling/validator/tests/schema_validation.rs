...
const VALID_PAIRS: &[(&str, &str)] = &[
    ...
    ("function-record.v0.2.schema.json", "reverse.json"),
    ("function-record.v0.2.schema.json", "append.json"),
    ("function-record.v0.2.schema.json", "length.json"),
    ("function-record.v0.2.schema.json", "add.json"),
    ("function-record.v0.2.schema.json", "foldr.json"),
    ("function-record.v0.2.schema.json", "foldl.json"),
