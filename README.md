...
- **Deeper ingestion + a richer runtime (v0.3+)** — the remaining effect kinds beyond the two effectful builtins, and effect/capability *gating* of what a delegation authorizes; and verification beyond example- and sampling-bound checks (a generative property engine that quantifies, proof certificates)
