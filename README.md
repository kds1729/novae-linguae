...
- **Deeper ingestion + a richer runtime (v0.3+)** — a real delegation-chain verifier behind the capability gate; and verification beyond *bounded* checks — full quantified proof over unbounded domains (an SMT / inductive backend) and machine-checkable proof certificates (today: example-bound, sampled, or bounded-exhaustive)
