...
# SMT-LIB 2, prove the negation unsat (PROVED) or find a counterexample (REFUTED). The emitted .smt2 is
# a re-checkable proof certificate. Needs an SMT solver (z3 by default); UNSUPPORTED outside Int/Bool.
