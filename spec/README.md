...
# to structural INDUCTION (base + step). The emitted .smt2 files are re-checkable proof certificates.
# Needs an SMT solver (z3 by default); UNKNOWN when an induction needs a lemma (e.g. reverse∘reverse).
